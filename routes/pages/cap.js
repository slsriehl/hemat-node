...
// router.all('/', (req, res) => {
//     return render(req, res, './page-views/cap/checklist.hbs', [
...
router.all('/appy-net', (req, res) => {
    return render(req, res, './page-views/cap/appy-net.hbs', [
		"/js/cap/appy-net-scripts.js",
	]);
});

router.all('/bone-t-rx', (req, res) => {
	return render(req, res, './page-views/cap/bone-t-rx.hbs', [
		"/js/cap/bonerx-scripts.js",
	]);
});

router.all('/neuro-t', (req, res) => {
	return render(req, res, './page-views/cap/neuro-t.hbs', [
		"/js/cap/neuro-scripts.js",
	]);
});

router.all('/neuro-t-biomarker', (req, res) => {
	return render(req, res, './page-views/cap/neuro-t-biomarker.hbs', [
...
router.all('/pnet-rx', (req, res) => {
	return render(req, res, './page-views/cap/pnet-rx.hbs', [
		"/js/cap/pnet-rx-scripts.js",
	]);
});

router.all('/colon-net', (req, res) => {
    return render(req, res, './page-views/cap/colon-net.hbs', [
    "/js/cap/colon-net-scripts.js",
]);
});

router.all('/ex-gon-gct', (req, res) => {
	return render(req, res, './page-views/cap/ex-gon-gct.hbs', [
		"/js/cap/exgct-scripts.js",
	]);
});

router.all('/duo-amp-net', (req, res) => {
    return render(req, res, './page-views/cap/duo-amp-net.hbs', [
    "/js/cap/duo-amp-net-scripts.js",
]);
});

router.all('/hepatoblastoma', (req, res) => {
	return render(req, res, './page-views/cap/hepatoblastoma.hbs', [
		"/js/cap/hepatoblastoma-scripts.js",
	]);
});

router.all('/neuroblast', (req, res) => {
	return render(req, res, './page-views/cap/neuroblast.hbs', [
...
router.all('/ovary-t', (req, res) => {
	return render(req, res, './page-views/cap/ovary-t.hbs', [
		"/js/cap/ovary-scripts.js",
	]);
});

router.all('/wilms-t', (req, res) => {
	return render(req, res, './page-views/cap/wilms-t.hbs', [
		"/js/cap/wilms-scripts.js",
	]);
});

router.all('/retinoblast', (req, res) => {
	return render(req, res, './page-views/cap/retinoblast.hbs', [
		"/js/cap/rb-scripts.js",
	]);
});

router.all('/rhabdo', (req, res) => {
	return render(req, res, './page-views/cap/rhabdo.hbs', [
		"/js/cap/rhabdo-scripts.js",
	]);
});

router.all('/testis-t', (req, res) => {
	return render(req, res, './page-views/cap/testis-t.hbs', [
		"/js/cap/testis-scripts.js",
	]);
});

router.all('/soft-t-rx', (req, res) => {
	return render(req, res, './page-views/cap/soft-t-rx.hbs', [
...
router.all('/prostate-t', (req, res) => {
    return render(req, res, './page-views/cap/prostate-t.hbs', [
...
router.all('/adrenal-t', (req, res) => {
    return render(req, res, './page-views/cap/adrenal-t.hbs', [
...
router.all('/ampulla-t', (req, res) => {
    return render(req, res, './page-views/cap/ampulla-t.hbs', [
...
router.all('/anal-t', (req, res) => {
    return render(req, res, './page-views/cap/anal-t.hbs', [
...
router.all('/appy-t', (req, res) => {
    return render(req, res, './page-views/cap/appy-t.hbs', [
    "/js/cap/appy-t-scripts.js",
]);
});

router.all('/breast-dcis', (req, res) => {
    return render(req, res, './page-views/cap/breast-dcis.hbs', [
...
router.all('/urethra-t', (req, res) => {
    return render(req, res, './page-views/cap/urethra-t.hbs', [
    "/js/cap/urethra-scripts.js",
]);
});

router.all('/ureter-pelvis-t', (req, res) => {
    return render(req, res, './page-views/cap/ureter-pelvis-t.hbs', [
    "/js/cap/ureter-scripts.js",
]);
});

router.all('/bladder-bx', (req, res) => {
    return render(req, res, './page-views/cap/bladder-bx.hbs', [
    "/js/cap/bladder-bx-scripts.js",
]);
});

router.all('/bladder-t', (req, res) => {
    return render(req, res, './page-views/cap/bladder-t.hbs', [
...
router.all('/uterine-sarc', (req, res) => {
    return render(req, res, './page-views/cap/uterine-sarc.hbs', [
...
router.all('/uveal-mel', (req, res) => {
    return render(req, res, './page-views/cap/uveal-mel.hbs', [
...
router.all('/vagina', (req, res) => {
    return render(req, res, './page-views/cap/vagina.hbs', [
...
router.all('/vulva', (req, res) => {
    return render(req, res, './page-views/cap/vulva.hbs', [
