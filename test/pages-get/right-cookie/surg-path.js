...
const tests = {
	ihc: function(done) {
		//page should load on authorized cookie
    ...
    .then(function(res) {
			...
			$('#Reset').should.exist;
			$('.report-button-box').should.exist;
	...
	snippets: function(done) {
		//page should load with authorized cookie
		...
		.then(function(res) {
			...
			$('#saveAsSnippet').should.exist;
			$('#writeReport').should.exist;
			$('#user-holder').should.exist;
			$('#class-holder').should.exist;
			$('#keyword-holder').should.exist;
			$('#entry_id-holder').should.exist;
			$('#outPut-1').should.exist;
