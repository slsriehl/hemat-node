$(window).on('load', function() {
    ...
    commLines = {
        ...
        commLine400 : 'The PT results suggest the presence of a factor deficiency or deficiencies in the extrinsic pathway (VII) and/or final common pathway (fibrinogen, II, V, X). It also be seen in the setting of vitamin-K deficiency. Clinical correlation and evaluation of medication history is recommended.\n\n',
