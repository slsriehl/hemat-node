...
// CELIAC SEROLOGY, NOT HISTOLOGY
        comLine102: 'The duodenum findings do not show changes typical of celiac disease. In some patients with strong clinical / serologic suspicion for celiac disease, the histologic manifestations can be patchy and/or focal within the small bowel.[1] If celiac disease is strongly suspected on clinicoserologic grounds, consideration for HLA-DQ typing on a peripheral blood sample may help provide additional support for this diagnosis [refer to Mayo Medical Laboratories test code CELI].\n\nReferences:\n1. Weir DC, et al. Variability of histopathological changes in childhood celiac disease. Am J Gastroenterol. 2010 Jan;105(1):207-12 \n',
