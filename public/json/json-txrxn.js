$(window).on('load', function(){
    dxOuts = {
        ...
        dxOut105 : '- Possible TRALI; defer to pending specialty testing (see comment)',
        ...
        dxOut108 : '- Symptoms most consistent with underlying clinical condition; No laboratory evidence of transfusion reaction (see comment)',
        dxOut109 : ''
...
// Don't add comma to last entry
    ...
    commLines = {
        ...
        commLine105 : 'The pattern of radiographic lung injury and possible temporal relationship to the time of transfusion allows for the possibility of TRALI. Correlation with ongoing anti-neutrophil antibody special testing is recommended. ',
