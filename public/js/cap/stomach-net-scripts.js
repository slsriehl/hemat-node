...
// *************************************************************/
    $('.writeReport').on('click', function () {
        ...
        if (box_10.indexOf("uninvolved") > -1) {
            ...
            captext += "+ Distance of tumor to closest margin: "+box_11_3+"mm\n";
            captext += "+ Closest margin to tumor: "+box_11_4+"\n";

        }
        else if (box_10.indexOf("involved") > -1) {
            captext += "\nMargins:";
            console.log("margins involved");
            if (box_1.indexOf('gastrectomy') > -1) {// gastrectomy
