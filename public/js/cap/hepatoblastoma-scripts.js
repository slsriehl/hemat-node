...
// *************************************************************/
    $('.writeReport').on('click', function () {
        ...
        var trig1_box_6 = box_6.filter(el => el.indexOf("organs") > -1);
        var trig2_box_6 = box_6.filter(el => el.indexOf("Other") > -1);
        ...
        var trig1_box_20 = box_20.filter(el => el.indexOf("Hepatitis") > -1);
