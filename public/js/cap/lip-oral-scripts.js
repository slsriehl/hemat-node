...
// *************************************************************/
    ...
    $('#box1').on("change", function(){
        var sel = $('#box1').val();
        var filt = sel.filter(el => el.indexOf('specify') > -1);
        if (filt.length > 0) {
            $('#box1_2').show();}
        else {$('#box1_2').hide();}
    });
...
// *************************************************************/
    ...
    // ***************** INPUT VALIDATION ********************//
        ...
        var filt = box_1.filter(el => el.indexOf('specify') > -1);
        var oth = box_1.filter(el => el.indexOf('Other') > -1);
        ...
        var trig1_box_28 = box_28.filter(el => el.indexOf("Other") > -1);
        var trig2_box_28 = box_28.filter(el => el.indexOf("type") > -1);
