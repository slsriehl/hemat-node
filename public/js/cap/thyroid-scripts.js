...
$(window).on('load', function () {
    ...
    $("input#box5").autocomplete({
        source: ["Papillary carcinoma, Classic (usual)", "Papillary carcinoma, Clear cell variant", "Papillary carcinoma, Columnar cell variant", "Papillary carcinoma, Cribriform-morular variant", "Papillary carcinoma, Diffuse sclerosing variariant", "Papillary carcinoma, Follicular variant, encapsulated/well demarcated, infiltrative", "Papillary carcinoma, Follicular variant, encapsulated/well demarcated, with tumor capsular invasion", "Papillary carcinoma, Follicular variant, encapsulated/well demarcated, non-invasive", "Papillary carcinoma, Hobnail variant", "Papillary carcinoma, Macrofollicular variant", "Papillary carcinoma, Microcarcinoma (microtumor)", "Papillary carcinoma, Oncocytic variant (follicular variant, nonfollicular variant)", "Papillary carcinoma, Solid variant", "Papillary carcinoma, Tall cell variant", "Papillary carcinoma, Warthin-like variant", "Follicular carcinoma, minimally invasive", "Follicular carcinoma, minimally invasive, oncocytic (Hürthle cell) variant", "Follicular carcinoma, minimally invasive, Clear cell variant", "Follicular carcinoma, minimally invasive, Mucinous variant", "Follicular carcinoma, minimally invasive, with signet cells", "Follicular carcinoma, encapsulated angioinvasive", "Follicular carcinoma, encapsulated angioinvasive, oncocytic (Hürthle cell) variant", "Follicular carcinoma, encapsulated angioinvasive, Clear cell variant", "Follicular carcinoma, encapsulated angioinvasive, Mucinous variant", "Follicular carcinoma, encapsulated angioinvasive, with signet cells", "Follicular carcinoma, widely invasive", "Follicular carcinoma, widely invasive, oncocytic (Hürthle cell) variant", "Follicular carcinoma, widely invasive, Clear cell variant", "Follicular carcinoma, widely invasive, Mucinous variant", "Follicular carcinoma, widely invasive, with signet cells", "Poorly differentiated thyroid carcinoma", "Undifferentiated (anaplastic) carcinoma, focal or minor component without extrathyroidal extension", "Undifferentiated (anaplastic) carcinoma, major component", "Undifferentiated (anaplastic) carcinoma, not otherwise specified", "Medullary carcinoma", "Carcinoma, type cannot be determined", "Other histologic type"],
        appendTo: '#Leftpanel'
    });
    ...
    $('#box23').on("change", function () {
        ...
        var trig1 = sela.filter(function (el) {
            return el.indexOf('Parathyroid') > -1;
        });
    ...
    $('#box24').on("change", function () {
        var sela = $('#box24').val();
        var trig1 = sela.filter(function (el) {
            return el.indexOf('Postoperative serum marker') > -1;
        });
        var trig2 = sela.filter(function (el) {
            return el.indexOf('Other') > -1;
        });
    ...
    $('.writeReport').on('click', function () {
        ...
        var trig1_box_23 = box_23.filter(function (el) {
            return el.indexOf("Parathyroid") > -1;
        });
