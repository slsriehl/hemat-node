...
$(window).on('load', function () {
    ...
    $("input#box5").autocomplete({
        source: ["Chondrosarcoma", "Chondrosarcoma, Dedifferentiated", "Mesenchymal chondrosarcoma", "Chondrosarcoma, Clear cell", "Osteosarcoma, Conventional", "Osteosarcoma, Chondroblastic", "Osteosarcoma, Fibroblastic", "Osteosarcoma, Osteoblastic", "Osteosarcoma, Telangiectatic", "Osteosarcoma, Small cell", "Osteosarcoma, Low grade central", "Osteosarcoma, Secondary", "Osteosarcoma, Parosteal", "Osteosarcoma, Periosteal", "Osteosarcoma, High grade surface", "Fibrosarcoma of bone", "Malignant fibrous histiocytoma (undifferentiated pleomorphic sarcoma)", "Ewing sarcoma/PNET", "Malignancy in giant cell tumor", "Chordoma", "Angiosarcoma", "Epithelioid hemangioendothelioma", "Leiomyosarcoma of bone", "Liposarcoma of bone", "Adamantinoma", "Metastatic malignancy", "Undifferentiaed high-grade pleomorphic sarcoma", "Malignant neoplasm"]
    });
