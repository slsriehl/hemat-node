...
// *************************************************************/
    ...
    $('#box17').on("change", function(){
        ...
        var trig2 = sela.filter(el => el.indexOf('findings') > -1);
        if (trig1.length > 0) {
            $('#box17_2').show();}
        else {$('#box17_2').hide();}
        if (trig2.length > 0) {
...
// *************************************************************/
    ...
    // ***************** INPUT VALIDATION ********************//
        ...
        var trig1_box_17 = box_17.filter(el => el.indexOf("polyps") > -1);
        var trig2_box_17 = box_17.filter(el => el.indexOf("findings") > -1);
