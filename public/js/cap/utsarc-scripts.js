...
// *************************************************************/
    $('.writeReport').on('click', function () {
        ...
        var captext = "Uterine Sarcoma Cancer Synoptic\n(pTNM requirements from the 8th Edition, AJCC Staging Manual)\n\n";
        ...
        if (box_5 != "Not applicable") {
            if (box_6.indexOf("Present") > -1) {
                captext += "\nMyometrial Invasion:\n- " + box_6 + "\n\t- Depth of invasion:  " + box_6_2 + "\n\t- Myometrial thickness: " + box_6_4 + "\n\t- Percentage of myometrial invasion: " + box_6_5 + "%\n";
        ...
        if ($("#box15").is(':checked')) {
            ...
            captext += "\nLymph nodes:\n" +
                "\tTotal Number of Nodes Examined: " + box_16 + "\n" +
                "\tNumber of Nodes with Metastasis (excludes ITCs): " + box_17 + "\n";

            if (box_18.length > 0) {
                captext += "\tNumber of Nodes with Isolated Tumor Cells: " + box_18 + "\n";
            }
