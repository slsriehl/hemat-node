...
$(window).on('load', function () {
    ...
    $('#box1').on("change", function () {
        ...
        if (sel.indexOf("other") > -1) {
            ...
            if (sel.indexOf("segmental resection") > -1) {
                // whipple
                $(".segmental").show();
            } else {
                $(".segmental").hide();
            }
            if (sel.indexOf("mucosal resection") > -1) {
                // whipple
                $(".emr").show();
            } else {
                $(".emr").hide();
    ...
    $('#box2').on("change", function () {
        var sel = $('#box2').val();
        console.log("sel:"+sel);
        var site0 = sel.filter(function (el) {
            return el.indexOf('Duodenum') > -1;
        });
        var site1 = sel.filter(function (el) {
            return el.indexOf('Ampulla') > -1;
        });
        var site2 = sel.filter(function (el) {
            return el.indexOf('Other') > -1;
        });
        console.log(site0, site1, site2);
        if (site0.length > 0) {
            $('.duo').show();
        } else {
            $('.duo').hide();
    ...
    $('.writeReport').on('click', function () {
        ...
        if (box_10.indexOf("uninvolved") > -1) {
            ...
            } else if (box_1.indexOf('mucosal resection') > -1) {
                // emr
