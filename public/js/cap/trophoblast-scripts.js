...
$(window).on('load', function () {
    ...
    $('#box6').on("change", function () {
        var sel = $('#box6').val();
        var trig = sel.filter(function (el) {
    ...
    $('.writeReport').on('click', function () {
        ...
        if (box_9 != "Not applicable") {
            captext += box_9.join("") + ' ' + box_10 + " " + box_12 + "\n";
        } else {
            captext += box_10 + " " + box_12 + "\n";
        }
        ...
        if (box_12 == "pM1b") {
            var trig1_box_16 = box_16.filter(function (el) {
                return el.indexOf("Lymph") > -1;
            });
            var trig2_box_16 = box_16.filter(function (el) {
                return el.indexOf("Other") > -1;
            });
