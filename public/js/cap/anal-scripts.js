...
// *************************************************************/
    ...
    $('#box2_2').on("input", function() {
        ...
        $(".resection").hide();
        $(".emr").hide();
        if (sel.indexOf("resection") > -1){ // whipple
            $(".segmental").show();
        } else {
            $(".segmental").hide();
        }
        if (sel.indexOf("mucosal") > -1){ // whipple
            $(".emr").show();
        } else {
            $(".emr").hide();
        }
    ...
    $('#box33').on("change", function(){
        ...
        var trig2 = sela.filter(el => el.indexOf('therapy') > -1);
        if (trig1.length > 0) {
            $('#box33_2').show();}
        else {$('#box33_2').hide();}
        if (trig2.length > 0) {
    ...
    // ***************** INPUT VALIDATION ********************//
        ...
        if (proc == 'resection') {
            ...
            if (box_16.indexOf("Uninvolved") > -1) {
                captext += "- Deep Margin:\n\t " + box_16 +
                    "\n\t Distance of invasive carcinoma to deep margin: " + box_16_2.replace(/mm/, "") +
                    "mm\n";
            }
            else {
                captext += "- Deep Margin:\n\t " + box_16 + "\n";
            ...
            if (box_17.indexOf("Uninvolved") > -1) {
                ...
                captext += "\tDistance of invasive carcinoma to mucosal margin: " + box_17_2.replace(/mm/, "") +
                    "mm\n";
            } else {
                captext += "\n- Mucosal Margin:\n\t " + box_17 + "\n";
            }
        ...
        var trig1_box_33 = box_33.filter(el => el.indexOf("Other") > -1);
        var trig2_box_33 = box_33.filter(el => el.indexOf("therapy") > -1);
