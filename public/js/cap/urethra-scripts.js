        ...
        if(box_7.indexOf("Not applicable") == -1){
            if (box_7.indexOf('adjacent') > -1){
                if ($.inArray('Other', box_7_2) > -1){
                    captext += "- Tumor invades adjacent structures, including: " + box_7_2.replace(/Other/, box_7_3) + "\n";
                }else {
                    captext += "- Tumor invades adjacent structures, including: " + box_7_2 + "\n";
                }
            }
            else {captext += "- "  + box_7.join('\n- ') + "\n";}
        }
        ...
        if(box_8.indexOf("Not applicable") == -1){
            if (box_8.indexOf('adjacent') > -1){
                if ($.inArray('Other', box_8_2) > -1){
                    captext += "- Tumor invades adjacent structures, including: " + box_8_2.replace(/Other/, box_8_3) + "\n";
                }else {
                    captext += "- Tumor invades adjacent structures, including: " + box_8_2 + "\n";
                }
            }
            else {captext += "- "  + box_8.join('\n- ') + "\n";}
        }
        ...
        if(box_9.indexOf("Not applicable") == -1){
            if (box_9.indexOf('adjacent') > -1){
                if ($.inArray('Other', box_9_2) > -1){
                    captext += "- Tumor invades adjacent structures, including: " + box_9_2.replace(/Other/, box_9_3) + "\n";
                }else {
                    captext += "- Tumor invades adjacent structures, including: " + box_9_2 + "\n";
                }
            }
            else {captext += "- "  + box_9.join('\n- ') + "\n";}
        }
