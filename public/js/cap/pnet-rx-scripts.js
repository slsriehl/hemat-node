...
// *************************************************************/
    ...
    $('#box10').on("change", function(){
        var sel = $('#box10').val();
        var pos = sel.filter(el => el.indexOf('Other') > -1);
...
// *************************************************************/
    $('.writeReport').on('click', function () {
        ...
        if (box_6.indexOf("Uninvolved") > -1) {
            ...
            if (box_6_2.length > 0){
                captext += "\t- Distance to nearest parenchymalmargin: " + box_6_2.replace(/mm/,"")+"mm\n";
            }
        }
        ...
        var pos = box_10.filter(el => el.indexOf('Other') > -1);
        captext += "\n-ANCILLARY STUDIES-"
        if (pos.length > 0){
